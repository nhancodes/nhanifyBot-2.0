...
const nhanifyQueue = new Queue({ type: "nhanify", title: "Something Random", length: 1, videos: [{ title: "Baby One More Time", id: "kAJz7c97Cyo" }] } as NhanifyQueue);

startWebSocketServer(chatQueue, nhanifyQueue);
...
//const ircClient = await startTwitchIRCWebSocketClient(IRC_WEBSOCKET_URL);
